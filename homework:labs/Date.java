...
class Date {
  ...
  public static boolean isLeapYear(int year) {
	boolean flag = true;
	  ...
	  else if(year%100==0&&year%400!=0) flag=false;		  
  ...
  public String toString() {
    return String.valueOf(month)+"/"+String.valueOf(day)+"/"+String.valueOf(year);                     // replace this line with your solution
  }
  ...
  public boolean isBefore(Date d) {
    boolean before = true;  	// replace this line with your solution
    if (this.year>d.year){
    	before = false;
    }
  ...
  public int dayInYear() {
    int days= 0;                           // replace this line with your solution
  ...
  public int difference(Date d) {
	  int add1=0;
	  int add2= this.dayInYear()-d.dayInYear();
	  if (this.year>=d.year){
		  for(int i=d.year;i<this.year;i++){
			  if(isLeapYear(i)) add1+=366;
			  else add1+=365;
		  }
	  }
	  if (this.year<d.year){
